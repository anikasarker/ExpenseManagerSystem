...
$select_income= "SELECT SUM(income_amount)FROM income WHERE income_month='$months'"  ;
...
$select_expense= "SELECT SUM(expense_amount)FROM expense WHERE expense_month='$months' "  ;
