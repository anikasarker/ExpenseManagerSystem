		...
		dataPoints: [
            <?php 
                ...
                while ($row_category= mysqli_fetch_array($run))
                {
                 ...
                 $select_total_expense= "SELECT SUM(expense_amount)FROM expense WHERE expense_month='$current_month'"  ;
...
<div class="col-xl-4 col-lg-5">
    <div class="card shadow mb-4 pre-scrollable">
       ...
       while( $row=mysqli_fetch_array($run_category)){
                 ...
                 $select_total_expense= "SELECT SUM(expense_amount) FROM expense WHERE expense_month='$current_month' AND category_id='$category_id'";
